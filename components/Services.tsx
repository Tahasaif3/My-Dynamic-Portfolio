...
export default function Services({ data }: { data: Service[] }) {
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-indigo-900 via-purple-900 to-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
              ...
              >
                <Card className="h-full bg-gray-800/70 border-gray-700 backdrop-blur-md hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-500/30 group">
                  <CardContent className="p-8 flex flex-col items-center text-center">
                    ...
                    <Button
                      variant="outline"
                      className="mt-auto group relative overflow-hidden border-2 border-purple-500 text-purple-500 hover:text-white font-semibold py-2 px-6 rounded-lg transition-all duration-300 hover:bg-gradient-to-r hover:from-purple-500 hover:via-pink-500 hover:to-red-500 shadow-md hover:shadow-lg"
                    >
        ...
        >
          <Button size="lg" className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-semibold py-3 px-8 rounded-full transition-all duration-300 transform hover:scale-105">
